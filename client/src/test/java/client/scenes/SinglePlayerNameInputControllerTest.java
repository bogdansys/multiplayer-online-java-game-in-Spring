...
class SinglePlayerNameInputControllerTest {

    private MainCtrl mainCtrl;
    private ServerUtils server;
    private SinglePlayerNameInputController controller;

    @BeforeEach
    public void setup() {
        this.mainCtrl = Mockito.mock(MainCtrl.class);
        this.server = Mockito.mock(ServerUtils.class);
        this.controller = new SinglePlayerNameInputController(mainCtrl, server);
    }
