...
class NameInputJoinLobbyControllerTest {

    private MainCtrl mainCtrl;
    private ServerUtils server;
    private WaitingRoomController waitingRoomController;
    private NameInputJoinLobbyController controller;
    ...
    public void setup() {
        ...
        this.controller = new NameInputJoinLobbyController(mainCtrl, server, waitingRoomController);
    }
